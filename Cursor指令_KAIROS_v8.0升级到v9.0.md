...
- [ ] 正文中没有出现"⭐ 升级"标注
- [ ] 正文中没有出现"（v8.0保留）"标注
- [ ] 正文中没有出现"v8.0 → v9.0"对比表
- [ ] 正文读起来像"产品说明书"，不像"升级公告"

...
DOC_MAPPING = {
    ...
    "DOC-D018": "种树型与种菜型商业模式.md",
    "DOC-D019": "你的粉丝不是你的——papi酱用8年证明的财富公式.md",
    "DOC-D020": "上帝密码已破解——所有复杂系统的解法都在这里.md",
    "DOC-D021": "维度跨越：为什么真正的机会从来不在现有竞争者能看到的空间里.md",
    "DOC-D022": "伪需求陷阱：当代理指标取代了真实价值.md",
    "DOC-D023": "不下牌桌——商业成功的唯一前提.md",
    "DOC-D024": "阶段错配-为什么大师的不死模式会害死普通人.md",
    "DOC-D025": "认知流变学.md",
    "DOC-D026": "生命信息论.md",
    "DOC-D027": "技术人的三大认知陷阱.md",
    "DOC-D028": "命运之手的年龄陷阱-为什么50岁开始也不晚.md",
    "DOC-D029": "神经可塑性与内在稳定-从刺激依赖到自我调节的理论框架.md",
    "DOC-D030": "解决方案的次生问题定律.md",
    # 术层文档
    "DOC-S001": "创新三元法.md",
    ...
    "DOC-S073": "健康分：从隐性经验到显性标准.md",
    "DOC-S074": "问题升维：你在解一道根本不存在的题.md",
    "DOC-S075": "创业者的十个默认假设：在你研究怎么赢之前，先搞清楚怎么不死.md",
    "DOC-S076": "多维价值锚点-为什么单一卖点的生意必死.md",
    "DOC-S077": "场景组装思维：从技术找场景到场景找轮子.md",
    "DOC-S078": "非线性放大窗口研究方法论.md",
    "DOC-S079": "即时反馈回路理论：如何设计驱动内在动机的系统.md",
    "DOC-S080": "AI创业大赛的思考.md",
    "DOC-S081": "责任锚点透镜-判断AI公司能不能活.md",
    "DOC-S082": "婚姻的8个真相-从热恋到长久的理性指南-公众号版.md",
    "DOC-S083": "红队攻击决策模式：基于集体智慧涌现的科学决策框架.md",
}

# 暂缓入库的子项目 mapping（不影响 build_index；恢复时复制到 DOC_MAPPING）
DOC_MAPPING_DEFERRED = {
    # ============ shangye-anli 子项目(暂缓) ============
    # 计划:商业案例库,11 个文档位
    # 状态:目录未建,暂缓推进
    # 恢复方法:建目录 + 复制下方注释中的 mapping 行到 DOC_MAPPING

# Claude Projects 完整指令 v3.0（兼容入口）

> 说明：本仓库已新增 **v3.1**（推荐使用），本文件仅作为历史文件名兼容与入口跳转。

## ✅ 请使用 v3.1（最新版）

- **文件**：`Claude_Projects指令V3.1.md`
- **用途**：Claude Projects 的 Custom Instructions（包含模式4三场景路由：理论/商业案例/AI竞品 + 失败降级策略）

## 为什么保留 v3.0 文件名？

因为仓库历史（以及部分README/旧链接）可能还引用 `Claude_Projects指令V3.0.md`，保留该文件名可以避免“找不到文件”的问题。
...
- 框架：优先调用 `business-cases/00_系统指令/Claude-案例拆解提示词.md`
  - 可选追加：`business-cases/00_系统指令/Claude-模型提炼提示词.md`、`Claude-洞察归纳提示词.md`
- 输出位置：`business-cases/01_案例库/.../<企业名>-<关键词>.md`
- 索引维护：更新 `business-cases/01_案例库/案例总索引.md`
